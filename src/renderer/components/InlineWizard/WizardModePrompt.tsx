            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs" style={{ color: theme.colors.textDim }}>
                  Start fresh with a new project plan. The wizard will ask you about
                  your project to generate new Auto Run documents.
                </p>
              </div>
            </div>
          </button>
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-xs" style={{ color: theme.colors.textDim }}>
                    Build upon your existing documents. Tell the wizard what you want
                    to add, change, or extend.
                  </p>
                </div>
              </div>
            </button>
